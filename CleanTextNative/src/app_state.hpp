...
enum ButtonId { None = 0, Settings = 1, Minimize = 2, Close = 3, ClearInput = 4, CopyOutput = 5, Color = 6, ApplyColor = 7, DeleteOutput = 8, Info = 9, Announcement = 10, Bilibili = 11, Github = 12, Support = 13, DarkMode = 14 };
...
struct AppState {
    ...
    bool settings = false, infoPage = false, announcementOpen = false, supportOpen = false, darkMode = false, topmost = true, startup = false, colorPicker = false, copied = false, compact = false, bubblePointerDown = false, bubbleMoved = false;
    COLORREF theme = kGreen;
    int hot = None, pressed = None, inputHeight = kInputMin, hotFilter = -1;
    RECT inputRect{}, outputRect{}, settingsRect{}, settingsButton{}, infoButton{}, darkModeButton{}, minButton{}, closeButton{}, clearButton{}, copyButton{}, deleteButton{}, startupCheck{}, topmostCheck{}, colorButton{}, applyColor{}, colorInputRect{}, filterInputRect{}, announcementButton{}, bilibiliLink{}, githubLink{}, supportButton{}, paymentImage{};
