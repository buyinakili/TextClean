...
void Renderer::shutdown() {
    if (!impl_) return; for (Cache* c : {&impl_->logoCache,&impl_->cancelCache,&impl_->copyCache,&impl_->settingsCache,&impl_->infoCache,&impl_->bilibiliCache,&impl_->githubCache,&impl_->darkModeCache}) if (c->bitmap) DeleteObject(c->bitmap);
